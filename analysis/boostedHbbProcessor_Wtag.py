...
class BoostedHbbProcessor(processor.ProcessorABC):
    ...
    def build_met_systematics(self, df):
        ...
        #Wtag
        muonx = df['vmuoLoose0_pt']*np.sin(df['vmuoLoose0_phi'])
        muony = df['vmuoLoose0_pt']*np.cos(df['vmuoLoose0_phi'])
    ...
    def process(self, df):
        ...
        regions['WtagRegion'] = {'muonselection','btaggedAk4','met','opposite_ak8_muon','final'}
