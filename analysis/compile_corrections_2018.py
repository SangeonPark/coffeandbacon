...
corrections['2018_pileupweight_dataset'] = pileup_corr
corrections['2018_pileupweight_dataset_puUp'] = pileup_corr_puUp
corrections['2018_pileupweight_dataset_puDown'] = pileup_corr_puDown
...
with lz4f.open("corrections_2018.cpkl.lz4", mode="wb", compression_level=5 ) as fout:
